...
public class Main {
    ...
    public static void main (String[] args) {
        ...
        SuppressionResponse suppressionResponse = mailgunSuppressionComplaintsApi.addAddressToComplaintsList(domain, ComplaintsSingleItemRequest.builder().address("john@domain.com").build());
        System.out.println(suppressionResponse);
    }
}
