...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // Fetch all logs filtered by duration with totals negated
        LogsResponse logsResponse = mailgunLogsApi.getLogs(LogsRequest.builder().duration("12h").includeTotals(false).build());
